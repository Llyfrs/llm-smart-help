...
class STEmbedding(EmbeddingModel):
    ...
    def metadata(self) -> Dict[str, Any]:
        return {
            ...
            'tokenizer_vocab_size': len(self.model.tokenizer.vocab) if hasattr(self.model.tokenizer, 'vocab') else None,
            'pooling_strategy': self.model.pooling_model.__class__.__name__ if hasattr(self.model,
                                                                                       'pooling_model') else None,
            ...
            'model_architecture': self.model.auto_model.__class__.__name__ if hasattr(self.model,
                                                                                      'auto_model') else None,
